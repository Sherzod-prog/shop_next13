...
const ShoppingCart = () => {
	...
	const removeProduct = (id: number) => {
		...
		localStorage.setItem('carts', JSON.stringify(updatedCard));
			...
			{products.length ? (
				...
				<div className='flex h-[calc(100vh-80px)] items-center justify-center p-5 bg-white w-full'>
					<div className='text-center'>
						...
						<Link href={'/products'}>
							<button className='inline-flex items-center text-white bg-gray-800 border-0 py-2 px-8 focus:outline-none hover:bg-gray-500 hover:text-black hover:font-3 rounded text-base mx-1 mt-8 md:mt-0'>
								Products
							</button>
						</Link>
					</div>
